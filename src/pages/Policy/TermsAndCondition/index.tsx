	...
	return (
		<Card className={styles['card-container']}>
			<Space size={15} direction="vertical">
				...
				<ul>
					<li>
						<p><strong>Application</strong> means the software program provided by the Company downloaded by You on any electronic device, named Velorona </p>
					</li>
					<li>
					...
					<li>
						<p><strong>Website</strong> refers to Velorona, accessible from <a href="https://www.velorona.com" rel="external nofollow noopener" target="_blank">https://www.velorona.com</a></p>
					</li>
					<li>
						<p><strong>You</strong> means the individual accessing or using the Service, or the company, or other legal entity on behalf of which such individual is accessing or using the Service, as applicable.</p>
					</li>
				</ul>
				<h1 className={styles["topic"]}>Acknowledgment</h1>
				<hr className={styles["topic_line"]}/>
				...
				<h1 className={styles["topic"]}>Subscriptions</h1>
				<hr className={styles["topic_line"]}/>
				<h2 className={styles["subtopic"]}>Subscription period</h2>
				...
				<h2 className={styles["subtopic"]}>Subscription cancellations</h2>
				...
				<h2 className={styles["subtopic"]}>Billing</h2>
				...
				<h2 className={styles["subtopic"]}>Fee Changes</h2>
				...
				<h2 className={styles["subtopic"]}>Refunds</h2>
				...
				<h2 className={styles["subtopic"]}>Free Trial</h2>
				...
				<h1 className={styles["topic"]}>User Accounts</h1>
				<hr className={styles["topic_line"]}/>
				...
				<h1 className={styles["topic"]}>Content</h1>
				<hr className={styles["topic_line"]}/>
				<h2 className={styles["subtopic"]}>Your Right to Post Content</h2>
				...
				<h2 className={styles["subtopic"]}>Content Restrictions</h2>
				...
				<h2 className={styles["subtopic"]}>Content Backups</h2>
				...
				<h1 className={styles["topic"]}>Copyright Policy</h1>
				<hr className={styles["topic_line"]}/>
				<h2 className={styles["subtopic"]}>Intellectual Property Infringement</h2>
				...
				<p>If You are a copyright owner, or authorized on behalf of one, and You believe that the copyrighted work has been copied in a way that constitutes copyright infringement that is taking place through the Service, You must submit Your notice in writing to the attention of our copyright agent via email at <a href="/cdn-cgi/l/email-protection" className="__cf_email__" data-cfemail="523b3c343d1224373e3d203d3c337c313d3f">[email&#160;protected]</a> and include in Your notice a detailed description of the alleged infringement.</p>
				...
				<h2 className={styles["subtopic"]}>DMCA Notice and DMCA Procedure for Copyright Infringement Claims</h2>
				...
				<p>You can contact our copyright agent via email at <a href="/cdn-cgi/l/email-protection" className="__cf_email__" data-cfemail="7c15121a133c0a1910130e13121d521f131152">[email&#160;protected]</a>
				...
				<h1 className={styles["topic"]}>Intellectual Property</h1>
				<hr className={styles["topic_line"]}/>
				...
				<h1 className={styles["topic"]}>Your Feedback to Us</h1>
				<hr className={styles["topic_line"]}/>
				...
				<h1 className={styles["topic"]}>Termination</h1>
				<hr className={styles["topic_line"]}/>
				<p>We may terminate or suspend Your Account immediately, without prior notice or liability, for any reason whatsoever, including without limitation if You breach these Terms and Conditions.</p>
				<p>Upon termination, Your right to use the Service will cease immediately. If You wish to terminate Your Account, You may simply discontinue using the Service.</p>
				<h1 className={styles["topic"]}>Limitation of Liability</h1>
				<hr className={styles["topic_line"]}/>
				...
				<h1 className={styles["topic"]}>&quot;AS IS&quot; and &quot;AS AVAILABLE&quot; Disclaimer</h1>
				<hr className={styles["topic_line"]}/>
				...
				<h1 className={styles["topic"]}>Governing Law</h1>
				<hr className={styles["topic_line"]}/>
				<p>The laws of the Country, excluding its conflicts of law rules, shall govern this Terms and Your use of the Service. Your use of the Application may also be subject to other local, state, national, or international laws.</p>
				<h1 className={styles["topic"]}>Disputes Resolution</h1>
				<hr className={styles["topic_line"]}/>
				<p>If You have any concern or dispute about the Service, You agree to first try to resolve the dispute informally by contacting the Company.</p>
				<h1 className={styles["topic"]}>For European Union (EU) Users</h1>
				<hr className={styles["topic_line"]}/>
				<p>If You are a European Union consumer, you will benefit from any mandatory provisions of the law of the country in which you are resident in.</p>
				<h1 className={styles["topic"]}>United States Federal Government End Use Provisions</h1>
				<hr className={styles["topic_line"]}/>
				...
				<h1 className={styles["topic"]}>United States Legal Compliance</h1>
				<hr className={styles["topic_line"]}/>
				<p>You represent and warrant that (i) You are not located in a country that is subject to the United States government embargo, or that has been designated by the United States government as a &quot;terrorist supporting&quot; country, and (ii) You are not listed on any United States government list of prohibited or restricted parties.</p>
				<h1 className={styles["topic"]}>Severability and Waiver</h1>
				<hr className={styles["topic_line"]}/>
				<h2 className={styles["subtopic"]}>Severability</h2>
				<p>If any provision of these Terms is held to be unenforceable or invalid, such provision will be changed and interpreted to accomplish the objectives of such provision to the greatest extent possible under applicable law and the remaining provisions will continue in full force and effect.</p>
				<h2 className={styles["subtopic"]}>Waiver</h2>
				<p>Except as provided herein, the failure to exercise a right or to require performance of an obligation under these Terms shall not effect a party's ability to exercise such right or require such performance at any time thereafter nor shall the waiver of a breach constitute a waiver of any subsequent breach.</p>
				<h1 className={styles["topic"]}>Translation Interpretation</h1>
				<hr className={styles["topic_line"]}/>
				<p>These Terms and Conditions may have been translated if We have made them available to You on our Service. You agree that the original English text shall prevail in the case of a dispute. </p>
				<h1 className={styles["topic"]}>Changes to These Terms and Conditions</h1>
				<hr className={styles["topic_line"]}/>
